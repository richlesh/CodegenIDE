...
public class AboutDialog {
    ...
    public static void show(JFrame parent, AppSettings settings) {
        JDialog dialog = new JDialog(parent, "About CodegenIDE", true);
        ...
        JLabel name = new JLabel("CodegenIDE");
        ...
        JLabel subtitle = new JLabel("An IDE for the Codegen Programming Language");
        ...
        link2.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                try { Desktop.getDesktop().browse(java.net.URI.create("https://github.com/richlesh/CodegenIDE/issues")); }
                catch (Exception ignored) {}
            }
        });
        panel.add(link2);
        ...
        if (LicenseDialog.isLicensed(settings)) {
            panel.add(Box.createVerticalStrut(14));
            JLabel thanks = new JLabel("<html><p style='text-align: center;'><b>Thank you for purchasing a<br>license for CodegenIDE!</b></p></html>");
